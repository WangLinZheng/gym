                    ...
                    <table class="table table-hover">
                        ...
                        <c:forEach items="${memberList}" var="memberList">
                            <tr>
                                ...
                                <td>${memberList.cardid}</td>
                                <td>${memberList.cardtime}</td>
                                <td>${memberList.mnumber}</td>
                                <td>${memberList.mgender}</td>
                                <td>${memberList.mage}</td>
                                <td>${memberList.mheight}</td>
                                <td>${memberList.mweight}</td>
                                <td>${memberList.mphone}</td>
                                <td>${memberList.cardclass}</td>
                                <td>${memberList.nextclass}</td>
                                <td> <a href="<%=request.getContextPath()%>/member/delmember?mid=${memberList.mid}">删除</a> </td>
                            </tr>
                        </c:forEach>
