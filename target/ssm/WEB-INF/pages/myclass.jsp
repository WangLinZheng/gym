        ...
        <div class="card mb-3">
            ...
            <table class="table table-hover" id="classordertable">
                ...
                <tr>
                    ...
                    <th scope="col" class="border-0">开课时间</th>
                    <th scope="col" class="border-0">退课</th>
                </tr>
                </thead>

                <tbody>
                <c:forEach var="myclass" items="${myClassOrder}">
                    <tr>
                        <td>${myclass.conum}</td>
                        <td>${myclass.coname}</td>
                        <td>${myclass.coteacher}</td>
                        <td>${myclass.cotime}</td>
                        <td>
                            <button type="button" class="mb-2 btn btn-sm btn-info mr-1"><a
                                    href="<%=request.getContextPath()%>/usermember/delmyclass?coid=${myclass.coid}"
                                    style="color: white">退课</a>
                            </button>
