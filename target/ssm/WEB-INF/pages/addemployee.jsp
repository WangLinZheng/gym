...
<head>
    ...
    <script type="text/javascript">
        function beforesubmit(form) {
            ...
            if (form.emppwd.value == "") {
                alert("请输入密码")
                return false;
            }
            if (form.empage.value == "") {
                alert("请输入年龄")
                return false;
            }
            if (form.staff.value == "") {
    ...
    <div class="container-fluid">
        ...
        <div class="card mb-3">
            <div class="addbody">
                ...
                <!-- 添加会员信息操作  -->
                <form action="<%=request.getContextPath()%>/employee/addemployee" method="post" name="form" onsubmit="return beforesubmit(form)">
                    <table align="center" class="table table-hover">
                        <tr>
                            <td align="center">用 户 名：</td>
                            <td><input type="text" class="form-control" placeholder="员工姓名" name="empname"></td>

                        </tr>
                        <tr>
                            <td align="center"> 账 号：</td>
                            <td><input type="text" class="form-control" disabled="disabled" placeholder="员工账号后台生成"></td>
                        </tr>

                        <tr>
                            <td align="center">初始密码：</td>
                            <td><input type="text" class="form-control" placeholder="pwd" name="emppwd"></td>
                        </tr>


                        <tr>
                            <td align="center"> 年 龄：</td>
                            <td><input type="text" class="form-control" placeholder="员工年龄" name="empage"></td>
                        </tr>

                        <tr>
                            <td align="center"> 性 别：</td>
                            <td><input type="text" class="form-control" name="empgender"> &nbsp;
                        ...
                        <%--                            <td><input type="text" class="form-control" placeholder="入职时间" name="entrytime"></td>--%>
                        <%--                        </tr>--%>

                        <tr>
                            <td align="center">备注信息：</td>
                            <td><input type="text" class="form-control" placeholder="备注" name="message"></td>
                        </tr>
