        ...
        <div class="card mb-3">
            ...
            <div class="delbody">
                ...
                <table class="table table-hover">
                    ...
                    <tr>
                        <th scope="col" class="border-0">员工姓名</th>
                        <th scope="col" class="border-0">员工卡号</th>
                        <th scope="col" class="border-0">员工性别</th>
                        <th scope="col" class="border-0">员工年龄</th>
                        <th scope="col" class="border-0">入职时间</th>
                        <th scope="col" class="border-0">职务</th>
                        <th scope="col" class="border-0">备注信息</th>
                    ...
                    <c:forEach items="${emplist}" var="emp">
                        <tr>
                            ...
                            <td>${emp.staff}</td>
                            <td>${emp.message}</td>
                            <td> <button type="button" class="mb-2 btn btn-sm btn-info mr-1"><a
                                    href="<%=request.getContextPath()%>/employee/delemployee?empid=${emp.empid}"
                                    style="color: white">开除</a>
                            </button></td>
                        </tr>
                    </c:forEach>
