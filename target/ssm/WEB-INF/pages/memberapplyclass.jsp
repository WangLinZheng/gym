...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    <a class="navbar-brand" >欢迎您，${member.mname}</a>
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
            <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Dashboard">
                <a class="nav-link" href="<%=request.getContextPath()%>/usermember/tomembermain">
                    <i class="fa fa-fw fa-dashboard"></i>
                    <span class="nav-link-text">会所主页</span>
                </a>
            </li>
            <li class="nav-item" data-toggle="tooltip" data-placement="right" >
                <a class="nav-link" href="<%=request.getContextPath()%>/usermember/tomemberzone">
                    <i class="fa fa-fw fa-area-chart"></i>
                    <span class="nav-link-text">个人中心</span>
                </a>
            </li>
            <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Tables">
                <a class="nav-link" href="<%=request.getContextPath()%>/usermember/tomemberapplyclass">
                    <i class="fa fa-fw fa-table"></i>
                    <span class="nav-link-text">报名选课</span>
                </a>
            </li>
            <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Components">
                ...
                <ul class="sidenav-second-level collapse" id="collapseComponents">
                    <li>
                        <a href="<%=request.getContextPath()%>/usermember/toUpdateMy">修改个人信息</a>

                    </li>
                    <li>
                        <a href="<%=request.getContextPath()%>/usermember/tomyclass?mnumber=${member.mnumber}">我的课程</a>
                    </li>
                </ul>
            </li>
        ...
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
                <a class="nav-link" href="<%=request.getContextPath()%>/logincontroller/tomemberlogin">
...
<div class="content-wrapper">
    <div class="container-fluid">
        ...
        <!-- 身体框架-->
        <div class="card mb-3">
            <%--            <form action="<%=request.getContextPath()%>/usermember/saveclassorder" method="post">--%>
            <table class="table table-hover" id="classordertable">
                ...
                <tr>
                    ...
                    <th scope="col" class="border-0">报名</th>
                </tr>
                </thead>

                <tbody>
                <c:forEach var="classtable" items="${classlist}">
                    <tr>
                        ...
                        <td>
                            <button type="button" class="mb-2 btn btn-sm btn-info mr-1"><a
                                    href="<%=request.getContextPath()%>/usermember/saveclassorder?classid=${classtable.classid}"
                                    style="color: white">报名</a>
                            </button>
<%--                            <button  class="mb-2 btn btn-sm btn-info mr-1">报名</button>--%>
                        </td>
...
<%--                // var coname = this.find("tr").eq(1).find("td").eq(2)--%>
<%--                var coname = $(this).parent().prev().prev().prev().prev().html();--%>
<%--                var coteacher = $(this).parent().prev().html();--%>
<%--                var comembername = $("#membername").attr("value");--%>
<%--                var conumber = $("#mnumber").attr("value");--%>
<%--                // alert(coname+coteacher+comembername+conumber)--%>
<%--                var classOrder = '{"coname":"' + coname + '","coteacher":"' + coteacher + '","comembername":"' + comembername + '","conumber":"' + conumber + '"}'--%>

<%--               // var classOrder = JSON.stringify(ClassOrder);--%>
<%--                alert(classOrder)--%>

<%--                $.ajax({--%>
<%--                    url: "<%=request.getContextPath()%>/usermember/saveclassorder",--%>
<%--                    type: "post",--%>
<%--                    data: "{classOrder}",--%>
