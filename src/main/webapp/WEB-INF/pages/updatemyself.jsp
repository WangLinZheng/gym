...
<div class="content-wrapper">
    <div class="container-fluid">
        ...
        <!-- 身体框架-->
        <div class="card mb-3">
            <form action="<%=request.getContextPath()%>/usermember/updateMy" method="post">
                <table align="center"  class="table table-hover">
                    <tr>
                        <td align="center">用 户 名：</td>
                        <td> <input type="text" class="form-control" value="${member.mname}" name="mname"></td>

                    </tr>
                    <tr>
                        <td align="center">会员账号：</td>
                        <td><input type="text" class="form-control" readonly="readonly" placeholder="会员账号不可修改" name="mnumber" value="${member.mnumber}"></td>
                    </tr>

                    <tr>
                        <td align="center">会员密码：</td>
                        <td><input type="text" class="form-control"   name="mpwd" value="${member.mpwd}"></td>
                    </tr>

                    <tr>
                        <td align="center"> 身 高：</td>
                        <td><input type="text" class="form-control" value="${member.mheight}" name="mheight"></td>
                    </tr>
                    <tr>
                        <td align="center"> 体 重：</td>
                        <td><input type="text" class="form-control" value="${member.mweight}" name="mweight"></td>
                    </tr>

                    <tr>
                        <td align="center"> 性 别：</td>
                        <td><input type="text" class="form-control" value="${member.mgender}" name="mgender" > &nbsp;

                    </tr>

                    <tr>
                        <td align="center"> 年 龄：</td>
                        <td><input type="text" class="form-control" value="${member.mage}" name="mage"> </td>
                    </tr>

                    <tr>
                        <td align="center">联系方式（手机号）：</td>
                        <td><input type="text" class="form-control" value="${member.mphone}" name="mphone"> </td>
                    </tr>
