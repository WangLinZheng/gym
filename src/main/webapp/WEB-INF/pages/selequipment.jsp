    ...
    <div class="container-fluid">
        ...
        <div class="card mb-3">
            <div class="card-header border-bottom">
                <h6 class="m-0">器械信息表</h6> </div>
            <div class="selbody">
                <div class="card-body p-0 pb-3 text-center">
                    <a href="<%=request.getContextPath()%>/equipmentController/toAddEquipment">添加器械</a>
                    <table class="table table-hover">
                        <thead class="bg-light">
                        <tr>
                            <th scope="col" class="border-0">器材编号</th>
                            <th scope="col" class="border-0">器材名称</th>
                            <th scope="col" class="border-0">器材位置</th>
                            <th scope="col" class="border-0">器材状态</th>
                            <th scope="col" class="border-0">器材备注信息</th>
                        ...
                        <c:forEach var="equ" items="${equipmentlist}">
                            <tr>
                                <td>${equ.eqid}</td>
                                <td>${equ.eqname}</td>
                                <td>${equ.eqlocation}</td>
                                <td>${equ.eqstatus}</td>
                                <td>${equ.eqmessage}</td>
                                <td><a href="<%=request.getContextPath()%>/equipmentController/delEquipment?eqid=${equ.eqid}">删除器械</a>
                                    <a href="<%=request.getContextPath()%>/equipmentController/toUpdateEquipment?eqid=${equ.eqid}">修改器械</a>
