...
<head>
    ...
    <script type="text/javascript">
        function beforeSubmit(addform) {
            var myreg = /^[1][3,4,5,7,8][0-9]{8}$/; //设置手机号正则表达式
            if (addform.mname.value == ""){
                alert("会员姓名未输入")
                return false;
            }
            if (addform.mgender.value == ""){
                alert("会员性别未输入")
                return false;
            }
            if (addform.mage.value == ""){
                alert("会员年龄未输入")
                return false;
            }
            if (addform.mweight.value == ""){
                alert("会员体重未输入")
                return false;
            }
            if (addform.mheight.value == ""){
                alert("会员身高未输入")
                return false;
            }
            if (!myreg.test(addform.mphone.value)) {
                alert("手机号不正确");
                return false;
            }
    ...
    <div class="container-fluid">
        ...
        <div class="card mb-3">
            <div class="addbody">
                ...
                <!-- 添加会员信息操作  -->
                <form action="<%=request.getContextPath()%>/member/saveMember" method="post" name="addform" onsubmit="return beforeSubmit(this)">
                    <table align="center"  class="table table-hover">
                        <tr>
                            <td align="center">会员姓名：</td>
                            <td> <input type="text" class="form-control" placeholder="Username" name="mname"></td>

                        </tr>
                        <tr>
                            <td align="center">设置密码：</td>
                            <td><input type="text" class="form-control" placeholder="初始密码默认123456" disabled="disabled"></td>
                        </tr>

                        <tr>
                            <td align="center"> 身 高：</td>
                            <td><input type="text" class="form-control" placeholder="()cm" name="mheight"></td>
                        </tr>
                        <tr>
                            <td align="center"> 体 重：</td>
                            <td><input type="text" class="form-control" placeholder="()kg" name="mweight"></td>
                        </tr>

                        <tr>
                            <td align="center"> 性 别：</td>
                            <td><input type="text" class="form-control" name="mgender" > &nbsp;

                        </tr>

                        <tr>
                            <td align="center"> 年 龄：</td>
                            <td><input type="text" class="form-control" placeholder="age" name="mage"> </td>
                        </tr>

                        <tr>
                            <td align="center"> 联系方式（手机号）：</td>
                            <td><input type="text" class="form-control" placeholder="phonenum" name="mphone"> </td>
                        </tr>

<%--                        <tr>--%>
<%--                            <td align="center">入会日期：</td>--%>
<%--                            <td><input type="text" class="form-control" readonly="readonly" placeholder="自动获取当前日期" name="cardtime"></td>--%>
<%--                        </tr>--%>

                        <tr>
                            <td align="center">会员卡号：</td>
                            <td><input type="text" class="form-control" placeholder="会员卡号后台自动生成"  name="cardid" disabled="disabled"></td>
                        </tr>

                        <tr>
                            <td align="center">购买课时：</td>
                            <td><input type="text" class="form-control" placeholder="购买课时" name="cardclass"> </td>
                        </tr>

<%--                        <tr>--%>
<%--                            <td align="center">剩余课时：</td>--%>
<%--                            <td><input type="text" class="form-control" placeholder="剩余课时" name="nextclass"> </td>--%>
<%--                        </tr>--%>
                        ...
                        <tr>
                            ...
                            <td></td>
                            <td align="center">
                                <input type="submit" value="办卡" class="btn btn-dark" ></td>
