    ...
    <div class="container-fluid">
        ...
        <div class="card mb-3">
            <div class="addbody">
                ...
                <!-- 添加器材操作  -->
                <form action="<%=request.getContextPath()%>/equipmentController/addEquipment" method="post">

                    <table align="center"  class="table table-hover">
                        <tr>
                            <td align="center">器械名称：</td>
                            <td><input type="text" class="form-control" placeholder="器械名称" name="eqname"></td>
                        </tr>

                        <tr>
                            <td align="center"> 器械位置：</td>
                            <td><input type="text" class="form-control" placeholder="器械位置" name="eqlocation"></td>
                        </tr>
                        <tr>
                            <td align="center"> 器械状态：</td>
                            <td><input type="text" class="form-control" placeholder="器械状态" name="eqstatus"></td>
                        </tr>

                        <tr>
                            <td align="center"> 器械备注信息：</td>
                            <td><input type="text" class="form-control" name="eqmessage" > &nbsp;
                        ...
                        <tr>
                            ...
                            <td></td>
                            <td align="center">
                                <input type="submit" class="btn btn-info" value="添加"></td>
