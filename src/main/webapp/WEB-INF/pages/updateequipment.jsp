...
<div class="content-wrapper">
    <div class="container-fluid">
        ...
        <!-- 身体框架-->
        <div class="card mb-3">
            <form action="<%=request.getContextPath()%>/equipmentController/updateEquipment" method="post">
                <c:forEach var="equlist" items="${eqlist}">
                <table align="center"  class="table table-hover">

                    <tr>
                        <td align="center">器械编号：</td>
                        <td> <input type="text" class="form-control" readonly="readonly"  value="${equlist.eqid}" name="eqid"></td>

                    </tr>
                    <tr>
                        <td align="center">器械名称：</td>
                        <td> <input type="text" class="form-control" value="${equlist.eqname}" name="eqname"></td>

                    </tr>
                    <tr>
                        <td align="center">器械位置：</td>
                        <td><input type="text" class="form-control"  name="eqlocation" value="${equlist.eqlocation}"></td>
                    </tr>

                    <tr>
                        <td align="center">器械状态：</td>
                        <td><input type="text" class="form-control"   name="eqstatus" value="${equlist.eqstatus}"></td>
                    </tr>

                    <tr>
                        <td align="center"> 器械备注信息：</td>
                        <td><input type="text" class="form-control" value="${equlist.eqmessage}" name="eqmessage"></td>
                    </tr>
