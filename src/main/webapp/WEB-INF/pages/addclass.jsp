<%@ page import="com.gym.controller.MemberController" %><%--
    ...
    <div class="container-fluid">
        ...
        <div class="card mb-3">
            <div class="addbody">
                ...
                <!-- 添加会员信息操作  -->
                <form action="<%=request.getContextPath()%>/classtable/addclass" method="post">
                    <table align="center"  class="table table-hover">
                        <tr>
                            <td align="center">课程编号：</td>
                            <td> <input type="text" class="form-control" placeholder="课程编号" name="classid"></td>
                        ...
                        <tr>
                            <td align="center"> 课程开始时间：</td>
                            <td><input type="text" class="form-control" placeholder="课程开始时间" name="classbegin"></td>
                        </tr>
                        <tr>
                            <td align="center"> 课程时长：</td>
                            <td><input type="text" class="form-control" placeholder="课程时长" name="classtime"></td>
                        </tr>

                        <tr>
                            <td align="center"> 代课教练：</td>
                            <td><input type="text" class="form-control" name="teacher" > &nbsp;
